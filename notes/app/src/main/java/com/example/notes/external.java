...
public class external extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv = findViewById(R.id.ls_ext);
        lv.setAdapter(adapter);
        NewNote = findViewById(R.id.add_external_bt);
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                try {
                    // get json like so
                    // JSONObject clickedJson = jsonarr.getJSONObject(position).toString()
                    // create intent and send this jsonObject there
                    //Toast.makeText(getApplicationContext(), "json clicked" + jsonarr.getJSONObject(position).toString(), Toast.LENGTH_SHORT).show();
        ...
        NewNote.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(getApplicationContext(),editnoteexternal.class);
                startActivity(i);
